<x-app-layout>
    @section('title', 'Report: Staff With Registrations')

    <x-slot name="header">
        Report: Staff With Registrations
    </x-slot>
    ...
    <div class="max-w-full mx-auto sm:px-6 lg:px-8 space-y-6">
        <form method="GET" action="{{ route('report.staffConcat.withRegistration') }}"
            ...
            <p class="mt-3 text-xs text-gray-500 dark:text-gray-400">Shows linked staff who have an event registration on ConCat.</p>
        </form>

        <div class="bg-white dark:bg-gray-800 shadow sm:rounded-lg overflow-hidden">
            <div class="px-5 py-4 border-b border-gray-200 dark:border-gray-700">
                <div class="flex items-center justify-between gap-4">
                    <h3 class="text-base font-semibold text-gray-900 dark:text-gray-100">Staff With Registrations ({{ $staffWithRegistration->count() }})</h3>
                    <a href="{{ route('report.staffConcat.withRegistration.export', request()->query()) }}"
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        @forelse($staffWithRegistration as $user)
                            <tr>
                        ...
                        @empty
                            <tr>
                                <td colspan="3" class="px-6 py-10 text-center text-sm text-gray-500 dark:text-gray-400">No linked staff with a registration found.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
