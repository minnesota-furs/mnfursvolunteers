                    ...
                    <form method="POST" action="{{ route('admin.tags.update', $tag) }}">
                        ...
                        <div class="mb-6">
                            ...
                            <select name="type" id="type"
                                ...
                                <option value="" {{ old('type', $tag->type) === null || old('type', $tag->type) === '' ? 'selected' : '' }}>Both Users &amp; Shifts</option>
                                <option value="user" {{ old('type', $tag->type) === 'user' ? 'selected' : '' }}>Users only</option>
                                <option value="shift" {{ old('type', $tag->type) === 'shift' ? 'selected' : '' }}>Shifts only</option>
                            </select>
                            @error('type')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
