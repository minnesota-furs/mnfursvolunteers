            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('admin.custom-fields.store') }}">
                        ...
                        <div class="mb-6">
                            <label class="flex items-center">
                                <input type="checkbox" name="user_editable" id="user_editable" value="1" {{ old('user_editable') ? 'checked' : '' }}
                                    class="rounded border-gray-300 text-brand-green shadow-sm focus:border-brand-green focus:ring-brand-green dark:bg-gray-700 dark:border-gray-600">
                        ...
                        <div class="mb-6">
                            <label class="flex items-center">
                                <input type="checkbox" name="force_set" id="force_set" value="1" {{ old('force_set') ? 'checked' : '' }}
                                    class="rounded border-gray-300 text-brand-green shadow-sm focus:border-brand-green focus:ring-brand-green dark:bg-gray-700 dark:border-gray-600">
