                        ...
                        <div class="space-y-8">
                            ...
                            <div>
                                ...
                                <div class="flex items-center justify-between mt-6">
                                    <div>
                                        <label for="advertise_registration_on_login" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                                            Advertise Registering on Login Page
                                        </label>
                                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                                            When enabled, the login page shows a side panel promoting account creation with a link to register. Disable to hide it.
                                        </p>
                                    </div>
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        <input type="checkbox" name="advertise_registration_on_login" id="advertise_registration_on_login"
                                            value="1"
                                            {{ old('advertise_registration_on_login', app_setting('advertise_registration_on_login', true)) ? 'checked' : '' }}
                                            class="sr-only peer">
                                        <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-brand-green/20 dark:peer-focus:ring-brand-green/40 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-brand-green"></div>
                                    </label>
                                </div>
