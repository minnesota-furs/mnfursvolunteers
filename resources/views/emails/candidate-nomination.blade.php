...
<body>
    <div class="container">
        <div class="header">
            <h1>{{ app_setting('organization_name', 'MNFursVolunteers') }} - Candidate Nomination</h1>
        </div>

        <div class="content">
            <p class="greeting">Hi {{ $user->name }},</p>

            <p>You have been nominated as a candidate in the following election:</p>
            ...
            <p style="font-size: 14px; color: #6b7280;">
                If you have any questions about the election or your candidacy, please contact the elections team.
            </p>
        </div>
