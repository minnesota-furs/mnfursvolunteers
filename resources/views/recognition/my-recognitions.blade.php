<x-app-layout>
    @section('title', 'My Recognition & Awards')
    <x-slot name="header">
        {{ __('My Recognition & Awards') }}
    </x-slot>
        ...
        <div class="px-4 sm:px-6 lg:px-8">
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">You haven't received any recognition or awards yet.</p>
                </div>
            @endif
        </div>
    </div>
