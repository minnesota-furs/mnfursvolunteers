...
return [
    ...
    */
    ...
    'styles' => [
        ...
        'vendor/laravel-grapesjs/assets/tailwind.min.css'
    ],
    ...
    */
    ...
    'canvas' => [
        'styles' => ['vendor/laravel-grapesjs/assets/tailwind.min.css'],
        'scripts' => [],
    ],
            ...
            [
                ...
                'options' => [
                    ...
                    'options' => [
                        ...
                        'removeButtons' => 'Preview,Print,Templates,Source,Form,Checkbox,Radio,TextField,Textarea,Select,Button,ImageButton,HiddenField,Flash,Table,About'
                    ],
                ],
            ],
            [
